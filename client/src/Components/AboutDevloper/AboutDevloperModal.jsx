    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="body1" paragraph>
          Tushar Chandwanni is an engineering student at The LNMIIT Jaipur, highly passionate about web development.
        ...
        <Typography variant="body1" paragraph>
          To delete your account, kindly drop an email to Tushar Chandwanni at:
          <br />
          <Link href="mailto:ayushanandmishra@gmail.com" target="_blank" rel="noopener noreferrer">
            tusharchandwanni@gmail.com
          </Link>
        </Typography>
